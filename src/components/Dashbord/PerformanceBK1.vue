...
export default {
  ...
  async mounted () {
    ...
    console.log('getPerformance', this.getDta())
  ...
  methods: {
    ...
    async getPerformance () {
      ...
      await axios
        .get(
          'http://localhost:5004/job_log/getReport_performance?shopId=' + this.shopId
        )
        .then(async response => {
          if (response.data) {
