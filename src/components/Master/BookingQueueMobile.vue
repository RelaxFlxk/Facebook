...
<script>
export default {
  props: ['branchParent', 'masBranchIDParent', 'drawerParent', 'menu1Parent', 'timeTableParent', 'rulesParent', 'masterTimeParent', 'dataItemTimesChangeParent', 'getTimesChangeParent', 'toggleParent', 'updateTimeTable'],
  components: {},
  created () {},
  computed: {
    width () {
